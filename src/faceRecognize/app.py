...
from faceRecognize.face import Faces
from faceRecognize.facerecognition import *
...
class FaceRecognitionApp:
    def __init__(self, master):
        ...
        background_image = Image.open("./faceRecognize/Background_files/Learn-Facial-Recognition-1024x718.jpg")
    ...
    def create_new_folder(self):
        initial_folder_path = "./facerec/data"
